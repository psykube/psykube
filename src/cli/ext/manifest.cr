def Psykube::Manifest.new(command : Psykube::CLI::Commands::Init)
  flags = command.flags
  ...
  # Set Resources
  container.resources = Manifest::Resources.from_flags(
    flags.cpu_request,
  ...
  if (password = flags.registry_password)
    ...
    ] of Psykube::Manifest::Shared::PullSecretCredentials | String
  end
